...
date: "Last compiled on: 15/02/2024"
output:
...
##### Formal definition (as stated in Ianiro et al., 2022 Nature Medicine; DOI: 10.1038/s41591-022-01964-3): The fraction of retained strains is defined as: the fraction of post-FMT strains shared with pre-FMT (shared strains between post-FMT and pre-FMT divided by the number of strains profiled at post-FMT) The fraction of donor strains as the fraction of post-FMT strains shared with the donor (shared strains between post-FMT and donor divided by the number of strains profiled at post-FMT).
